...
function EmptyState({ onUpload }: { onUpload: () => void }) {
  return <main className="empty-main">
    <section className="hero-simple">
      ...
      <div className="format-note"><FileText size={16} /><span><strong>Supported Logs</strong><small>OpsCentral SocketIO / EFV<br />Asterisk / FreePBX<br />.log / .txt · Up to 50 MB</small></span></div>
    </section>
